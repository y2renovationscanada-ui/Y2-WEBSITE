...
export const processSteps = [
  ...
  },
  {
    ...
    description:
      "Our design team lays out finishes and layout options based on what you're going for, with 3D visuals when they'll help you picture the finished space. If your project involves structural changes, we handle the engineering and pull the permits ourselves.",
  },
  {
    step: "03",
...
export const quoteForm = {
  projectTypes: ["Bathroom", "Kitchen", "Basement", "Flooring", "Painting", "Full House", "Commercial", "Other"],
