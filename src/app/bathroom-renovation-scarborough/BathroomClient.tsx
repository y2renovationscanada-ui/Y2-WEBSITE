    ...
    <>
          ...
          <div className="container-page relative flex min-h-[480px] items-center py-16">
            <div className="max-w-2xl">
              <p className="mb-3 text-xs font-bold uppercase tracking-[0.2em] text-accent">
                Searching for bathroom renovation Scarborough?
              </p>
      ...
      >
        <p className="text-lg font-bold">
            Save $2,500 On Your Bathroom Renovation Scarborough.
        </p>
      ...
      <section className="section-pad bg-white">
        <div className="container-page">
          <h2 className="text-3xl font-bold text-brand-dark">
            Bathroom Renovations in Scarborough
          </h2>
          <p className="mt-4 max-w-3xl text-muted">
Older Scarborough Village and Milliken homes tend to have small, closed-off main baths with original tubs and dated tile. Newer Cornell and Wismer builds usually have the space, but were finished with builder-grade fixtures.
          </p>
          
          <p className="mt-4 max-w-3xl text-muted">
Our office and design studio are at 3400 14th Ave, Unit 16 , so in Scarborough we are not travelling to a job, we are working in our own neighbourhood. We cover:</p>
