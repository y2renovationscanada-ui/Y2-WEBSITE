    ...
    <>
          ...
          <div className="container-page relative flex min-h-[480px] items-center py-16">
            <div className="max-w-2xl">
              <p className="mb-3 text-xs font-bold uppercase tracking-[0.2em] text-accent">
                Searching for Kitchen Renovation Markham?
              </p>
      ...
      >
        <p className="text-lg font-bold">
          Save $2,500 On Your Kitchen Renovation Markham.
        </p>
      ...
      <section className="section-pad bg-white">
        <div className="container-page">
          <h2 className="text-3xl font-bold text-brand-dark">
           Kitchen Renovations in Markham
          </h2>
          <p className="mt-4 max-w-3xl text-muted">
A lot of Markham kitchens were laid out for a different era of cooking, closed off from the living space, short on counter run, heavy on original oak. Newer Berczy Village and Greensborough builds usually have the footprint, but builder-grade cabinetry throughout.

          </p>
          <p className="mt-4 max-w-3xl text-muted">
           Our office and design studio are at 3400 14th Ave, Unit 16, so in Markham we are not travelling to a job, we are working in our own neighbourhood. We cover:
          </p>
