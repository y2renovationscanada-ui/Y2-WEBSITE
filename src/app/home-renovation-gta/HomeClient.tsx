...
You Don't Need A New House. You Need This One Fixed.
              </h1>
...
Moving Is Expensive. Staying Doesn't Have To Be Compromise.
              </h2>
...
Concept, design, construction and final walkthrough handled in-house. On a whole-home project this is the single biggest difference, you have one number to call about every part of it.
              ...
              <p className="mt-2 leading-relaxed text-muted">
Free, no-obligation consultation and quote. On a project this size, the planning conversation is worth having even if you are still a year away from starting.
</p>
              <h3 className="mt-4 text-xl font-bold text-brand-dark">
...
Across the GTA there are thousands of structurally excellent houses that are cosmetically thirty years old. In a lot of neighbourhoods, renovating the house you have is a better return than buying up two streets over.
          </p>
          <p className="mt-4 max-w-3xl text-muted">
We also build location-specific pages for Markham, Scarborough, Ajax and Pickering — link to those from here.
          </p>
