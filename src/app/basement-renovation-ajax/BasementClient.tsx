...
Most Ajax homes were built with full-height basements that never got finished past the studs. In Unionville and Angus Glen we are usually building media rooms and home offices. In Milliken and Ajax Village, in-law suites for multigenerational households.
          </p>
          <p className="mt-4 max-w-3xl text-muted">
